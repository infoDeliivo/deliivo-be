...
router.post('/users/:id/rewards/reverse/:entryId', validate({ params: z.object({ id: z.string().min(1), entryId: z.string().min(1) }), body: rewardReversalSchema }), asyncHandler<AuthRequest>(RewardsController.reverseRewardEntry));
